...
#define HAVE_SUPPORTED_CURVES  /* To odblokuje funkcję wolfSSL_CTX_UseSupportedCurve */
#define HAVE_ECC               /* Wymagane dla X25519 i P-256 */
#define HAVE_CURVE25519        /* Wymagane dla X25519 */
...
/* ML-DSA (Dilithium) - Musisz włączyć konkretne poziomy! */
#define HAVE_DILITHIUM
#define WOLFSSL_WC_DILITHIUM
/* Cache matrix A in key state to lower peak one-shot XMALLOC during sign. */
#define WC_DILITHIUM_CACHE_MATRIX_A

#define HAVE_ML_DSA
#define WOLFSSL_MLDSA44    /* To odblokowuje ML-DSA-44 (Kategoria 2) */
#define WOLFSSL_MLDSA65    /* To odblokowuje ML-DSA-65 (Kategoria 3) */
#define WOLFSSL_MLDSA87    /* To odblokowuje ML-DSA-87 (Kategoria 5) */

/* Dodatkowe flagi dla kompatybilności */
#define OPENSSL_ALL
#define OPENSSL_EXTRA
#define HAVE_SECRET_CALLBACK
#define WOLFSSL_KEYLOG_HELPER
#define WOLFSSL_KEYLOGFILE
#define WOLFSSL_TLS13
...
#define HAVE_ML_KEM
#define WOLFSSL_MLKEM512   /* Wymagane dla WC_ML_KEM_512, którego używasz */
#define WOLFSSL_MLKEM768   /* Opcjonalnie */
#define WOLFSSL_MLKEM1024  /* Opcjonalnie */
